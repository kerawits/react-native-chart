...
_react2.default.createElement(_reactNative.View,{ref:'yAxis',style:{position:'absolute',height:_this2.props.height}},
function(){
if(_this2.props.showYAxis){
return(
...
}}]);return Chart;}(_react.Component);Chart.defaultProps={data:[],animated:false,animationDuration:300,axisColor:C.BLACK,axisLabelColor:C.BLACK,axisLineWidth:1,axisTitleColor:C.GREY,axisTitleFontSize:16,chartFontSize:14,dataPointRadius:3,gridColor:C.BLACK,gridLineWidth:0.5,hideHorizontalGridLines:false,hideVerticalGridLines:false,horizontalScale:1,labelFontSize:10,lineWidth:1,showAxis:true,showXAxis:true,showYAxis:true,showDataPoint:false,showGrid:true,showXAxisLabels:true,showYAxisLabels:true,tightBounds:false,verticalGridStep:4,xAxisHeight:20,yAxisWidth:30};exports.default=Chart;
